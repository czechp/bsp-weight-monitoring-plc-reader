...
class StartUpDevelopment {
    ...
    void startUp() throws IOException {
        ...
        final var plcConfigurationModuleFirst = new PlcConfiguration("192.168.1.46", 32, 10, 34);
        final var plcConfigurationModuleLast = new PlcConfiguration("192.168.1.46", 33,10,  35);
